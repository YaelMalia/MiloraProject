...
<!--  -->
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="HorasD" placeholder="Horas de trabajadas para este proceso" style="pointer-events:none;">
        </div>
...
<script>
      $("#botonExcel").click(function() {
        ...
        // Obtener el número de filas y columnas en la tabla
            ...
            // Exportar el libro como un archivo Excel
            XLSX.writeFile(wb, "Reporte-Cargas-Detallado.xlsx");
